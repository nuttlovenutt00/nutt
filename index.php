<?php
  ...
  function sendMessage($replyJson, $sendInfo){
   ...
   $replyText["type"] = "text";
 	...
 	$replyText1= array(
 	 "type" => "image",
    "originalContentUrl" => "https://github.com/nuttlovenutt00/nutt/blob/master/fiy.jpg?raw=true",
    "previewImageUrl" => "https://github.com/nuttlovenutt00/nutt/blob/master/fiy.jpg?raw=true"
	);
