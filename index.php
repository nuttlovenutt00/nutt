<?php
  ...
  { 
      $mysql->query("INSERT INTO `order_temp`(`ort_date`, `ort_time`, `ort_q`, `ort_status`, `ort_user_id`, `ort_unit`, `ort_pricetotal`, `ort_per_id`) 
        VALUES ('111','222','333','222','333','222','333','222','333')");
